...
%%Vizualizácia detekčnej charakteristiky pre ToF laserový senzor VL53L1X (TOF400C)
%%Detekčná charakteristika: 27°, softvérovo upraviteľné na 15° cez ROI (Region of Interest) + možnosť vychýliť

close all;
clear all;
half_angle = 13.5; %%27° detection angle / 2
...
title('Detekčná charakteristika senzora VL53L1X (TOF400C) - 27° FoV')
grid minor
