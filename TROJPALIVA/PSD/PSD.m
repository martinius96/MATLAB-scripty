...
for i = 1:length(files)
    try
        ...
        % Vykreslenie krivky do spoločného grafu (použitie RGB farieb)
        plot(f, pxx_db, 'Color', colors{i}, 'LineWidth', 1.5);
...
% --- ZMENA: Nastavenie osi X na rozsah 0 až 6000 Hz ---
xlim([0, 6000]); 
