...
%%Zadanie: Mapa terminálov
%%Matlab: R2016b
%%Popis úlohy:
%%1. Na ploche 1000x1000m zakreslite 3 body s označením súradnic x a y oddelenými čiarkou a uzatvrenými v hranatých zatvorkách. Vzdialenosť bodov minimálne 400m. 
%%Body označte krížikom a umiestnite ich tak, aby tvorili vrchol trojuholníka. Tieto body budú reprezentovať referenčné body (základňové stanice).
%%2. Medzi zvolené body umiestnite 4. bod tak, aby bol v trojuholníku, približne v jeho strede. 
%%Tento bod bude reprezentovať mobilnú stanicu, ktorej polohu budeme určovať na základe jej vzdialenosti od referenčných bodov v niektorom z nasledujúcich zadaní napr. kružnicovou trilateráciou.
