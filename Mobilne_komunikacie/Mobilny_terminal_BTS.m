...
%%Popis úlohy:
%%1. Na ploche 1000x1000m zakreslite 3 body s označením súradnic x a y oddelenými čiarkou a uzatvrenými v hranatých zatvorkách. 
%%Vzdialenosť bodov minimálne 400m. Body označte krížikom a umiestnite ich tak, aby tvorili vrchol trojuholníka. 
%%Tieto body budú reprezentovať referenčné body (základňové stanice).
%%2. Medzi zvolené body umiestnite 4. bod tak, aby bol v trojuholníku, približne v jeho strede. 
%%Tento bod bude reprezentovať mobilnú stanicu, ktorej polohu budeme určovať na základe jej vzdialenosti 
%%od referenčných bodov v niektorom z nasledujúcich zadaní napr. kružnicovou trilateráciou.
%%3. Vypočítajte vzdialenosti medzi vrcholmi bodov trojuholníka, spojte ich čiarkovanou čiarou čiernej farby 
%%ku ktorej napíšete vypočítanú dĺžku do okrúhlych zátvoriek.
%%4. Vypočítajte vzdialenosť 4. bodu a vrcholov trojuholníka. 
%%Spojte tieto body červenou čiarkovanou čiarou a pripíšte k nej vypočítanú vzdialenosť.

%%Funkčnosť scriptu:
%%script vygeneruje X suradnice BTS stanic, pricom zachovava vzdialenost v pravouhlom suradnicovom systeme min. 400 metrov
%%mobilny terminal je umiestneny do stredu trojuholnika, ktory je tvoreny BTS stanicami
%%stred sa vypocita taznicami, resp. je urceny taziskom.
%%nasledne sa vypocitaju a vykreslia aj jednotlive vzdialenosti medzi BTS a mobilnym terminalom
%%predpriprava ku scriptu kruznicovej trilateracie
